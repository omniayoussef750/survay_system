...
return new class extends Migration
{
    ...
    {
            Schema::table('built_in_questions', function (Blueprint $table) {
            \DB::statement("ALTER TABLE built_in_questions MODIFY question_type ENUM('text', 'single_choice', 'checkbox', 'likert_scale', 'slider', 'ranking', 'date', 'file_upload') NOT NULL");
        });
    }
};
